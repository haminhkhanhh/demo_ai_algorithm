...
$("#mazes .dropdown-item").click(function () {
  ...
  if (maze == "Ngẫu nhiên") {
    randomMaze();
  } else if (maze == "Phân chia đệ quy") {
    recursiveDivMaze(null);
  } else if (maze == "Phân chia đệ quy (Dọc)") {
    recursiveDivMaze("VERTICAL");
  } else if (maze == "Phân chia đệ quy (Ngang)") {
    recursiveDivMaze("HORIZONTAL");
  } else if (maze == "Xoắn ốc đơn giản") {
    spiralMaze();
  }
  console.log("Ma trận đổi thành: " + maze);
});
...
function updateSpeedDisplay() {
  if (animationSpeed == "Chậm") {
    $(".speedDisplay").text("Tốc độ: Chậm");
  } else if (animationSpeed == "Bình thường") {
    $(".speedDisplay").text("Tốc độ: Bình thường");
  } else if (animationSpeed == "Nhanh") {
    $(".speedDisplay").text("Tốc độ: Nhanh");
  }
  return;
}

function updateStartBtnText() {
  if (algorithm == "Tìm kiếm theo chiều sâu (DFS)") {
    $("#startBtn").html("Bắt đầu DFS");
  } else if (algorithm == "Tìm kiếm theo chiều rộng (BFS)") {
    $("#startBtn").html("Bắt đầu BFS");
  } else if (algorithm == "Dijkstra") {
    $("#startBtn").html("Bắt đầu Dijkstra");
  } else if (algorithm == "A*") {
    $("#startBtn").html("Bắt đầu A*");
  }
  return;
}
